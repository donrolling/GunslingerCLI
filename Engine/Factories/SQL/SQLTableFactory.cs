...
namespace Engine.Factories.SQL
{
	...
	{
		public static IEnumerable<SQLTable> Create(string @namespace, Domain.Enums.ProgrammingLanguage language, IEnumerable<Table> tables, Template template)
		{
		...
		private static OperationResult<SQLBasicTable> createBasicTable(string @namespace, ProgrammingLanguage language, Table table, Template template)
		{
		...
		private static List<SQLColumn> getSQLColumns(Name modelName, ProgrammingLanguage language, ColumnCollection columns, Template template)
		{
